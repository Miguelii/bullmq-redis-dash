   ...
   return (
      <main className="@container/main flex flex-1 flex-col gap-2 px-5 py-10 md:p-10">
         ...
         <section className="mb-10">
            ...
            <p>
               This application simulates a basic SaaS platform that any team could use to automate
               and monitor operational tasks. It demonstrates how queues can be used to handle heavy
               jobs like mass emailing and scheduled posts — all without blocking the main thread of
               your app.
            </p>
         </section>
